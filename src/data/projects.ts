...
export const projects: readonly Project[] = [
  {
    ...
    longSummary: {
      pt: "Site pessoal pensado como diario de expedicao, com experiencia bilingue, animacoes on-scroll leves e arquitetura de dados centralizada em arquivos tipados. Cada secao pode receber novos artefatos sem alterar a estrutura visual.",
    ...
    stack: ["Next.js", "React", "TypeScript", "Tailwind", "i18n", "Biome", "Vercel", "Cloudflare"],
  ...
  },
  {
    ...
    stack: ["Electron", "TypeScript", "React", "Tailwind", "i18n", "SQLite", "Drizzle"],
    links: [
